...
print("Read csv.")
transaction = pd.read_csv("result_transaction.csv", sep = '|', dtype=object)
...
print("Write to 'firm_group_v1.csv'.")
back3.to_csv("firm_group/firm_group_0.9.csv", sep='|', index = False)
